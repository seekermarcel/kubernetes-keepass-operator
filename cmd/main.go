...
import (
	...
	"github.com/seekermarcel/kubernetes-keepass-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "94137aa9.keepass.io",
	...
	if err := (&controller.KeePassSecretReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KeePassSecret")
		os.Exit(1)
	}
